...
export const metadata = {
  ...
  description:
    "Schedule your professional cleaning service in Delhi NCR. Get in touch with OMCAS for residential deep cleaning, office maintenance, and hygiene enquiries.",
  keywords:
